...
//SYSUT2   DD DSN=HERC01.DYNALOAD.ASM,DISP=(NEW,CATLG,DELETE),          00000180
...
//SYSUT2   DD DSN=HERC01.DYNALOAD.COBOL,DISP=(NEW,CATLG,DELETE),        00003280
...
//ASM.SYSIN DD DSN=HERC01.DYNALOAD.ASM(DYNALOAD),DISP=SHR               00003370
//LKED.SYSLMOD DD DSN=HERC01.DYNALOAD.LOADLIB(DYNALOAD),                00003380
...
//COB.SYSIN DD DSN=HERC01.DYNALOAD.COBOL(TESTDYNA),DISP=SHR             00003470
//LKED.SYSLIB DD                                                        00003480
//        DD DSN=HERC01.DYNALOAD.LOADLIB,DISP=SHR                       00003490
//LKED.SYSLMOD DD DSN=HERC01.DYNALOAD.LOADLIB(TESTDYNA),DISP=SHR        00003500
//*                                                                     00003510
//*  NOW COMPILE THE COBOL TEST SUBROUTINE                              00003520
//*                                                                     00003530
//STEP6 EXEC COBUCL                                                     00003540
//COB.SYSIN DD DSN=HERC01.DYNALOAD.COBOL(TESTDYN1),DISP=SHR             00003550
//LKED.SYSLMOD DD DSN=HERC01.DYNALOAD.LOADLIB(TESTDYN1),DISP=SHR        00003560
