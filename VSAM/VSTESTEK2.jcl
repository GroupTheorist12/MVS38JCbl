//VSTESTK2 JOB 'JAY MOSELEY',CLASS=A,MSGLEVEL=(1,1),MSGCLASS=A,         00010000
//             REGION=4096K                                             00020000
//*                                                                     00030000
//********************************************************************* 00040000
//* COBOL MODULE: KSDSLOAD     VSAM DATASET: VSTESTKS.CLUSTER (KSDS)    00050000
//*                                                                     00060000
//* SEQUENTIALLY LOADS DATASET USING TEST DATA FROM SEQUENTIAL DATASET  00070000
//********************************************************************* 00080000
//*                                                                     00090000
...
//SYSIN    DD  DSN=MVS.VSAMIO.SOURCE(KSDSLOAD),DISP=SHR                 00200000
//*                                                                     00210000
...
//KSDSF01  DD  DSN=VSTESTKS.CLUSTER,DISP=OLD                            00360000
//                                                                      00370000
