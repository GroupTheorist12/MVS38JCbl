//VSTESTE3 JOB 'JAY MOSELEY',CLASS=A,MSGLEVEL=(1,1),MSGCLASS=A,         00010000
//             REGION=4096K                                             00020000
//*                                                                     00030000
//********************************************************************* 00040000
//* COBOL MODULE: ESDSREAD     VSAM DATASET: VSTESTES.CLUSTER (ESDS)    00050000
//*                                                                     00060000
//* SEQUENTIALLY READS ALL RECORDS FROM ENTRY SEQUENCED DATASET         00070000
//********************************************************************* 00080000
//*                                                                     00090000
...
//SYSIN    DD  DSN=MVS.VSAMIO.SOURCE(ESDSREAD),DISP=SHR                 00200000
//*                                                                     00210000
...
//ESDSF01  DD  DSN=VSTESTES.CLUSTER,DISP=OLD                            00350000
//                                                                      00360000
