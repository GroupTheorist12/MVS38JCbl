//VSTESTR5 JOB 'JAY MOSELEY',CLASS=A,MSGLEVEL=(1,1),MSGCLASS=A,         00010000
//             REGION=4096K                                             00020000
//*                                                                     00030000
//********************************************************************* 00040000
//* COBOL MODULE: RRDSUPDT     VSAM DATASET: VSTESTRR.CLUSTER (RRDS)    00050000
//*                                                                     00060000
//* SEQUENTIALLY READ RECORDS AND UPDATE OR DELETE SELECTED RECORDS     00070000
//********************************************************************* 00080000
//*                                                                     00090000
...
//SYSIN    DD  DSN=MVS.VSAMIO.SOURCE(RRDSUPDT),DISP=SHR                 00200000
//*                                                                     00210000
...
//RRDSF01  DD  DSN=VSTESTRR.CLUSTER,DISP=OLD                            00350000
//                                                                      00360000
