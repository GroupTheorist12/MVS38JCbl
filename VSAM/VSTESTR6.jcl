//VSTESTR6 JOB 'JAY MOSELEY',CLASS=A,MSGLEVEL=(1,1),MSGCLASS=A,         00010000
//             REGION=4096K                                             00020000
//*                                                                     00030000
//********************************************************************* 00040000
//* COBOL MODULE: RRDSRAND     VSAM DATASET: VSTESTRR.CLUSTER (RRDS)    00050000
//*                                                                     00060000
//* RANDOMLY ACCESS DATASET AND ADD, UPDATE, OR DELETE RECORDS          00070000
//********************************************************************* 00080000
//*                                                                     00090000
...
//SYSIN    DD  DSN=MVS.VSAMIO.SOURCE(RRDSRAND),DISP=SHR                 00200000
//*                                                                     00210000
