//VSTESTR3 JOB 'JAY MOSELEY',CLASS=A,MSGLEVEL=(1,1),MSGCLASS=A,         00010000
//             REGION=4096K                                             00020000
//*                                                                     00030000
//********************************************************************* 00040000
//* COBOL MODULE: RRDSREAD     VSAM DATASET: VSTESTRR.CLUSTER (RRDS)    00050000
//*                                                                     00060000
//* SEQUENTIALLY READS ALL RECORDS FROM DATASET                         00070000
//********************************************************************* 00080000
//*                                                                     00090000
...
//SYSIN    DD  DSN=MVS.VSAMIO.SOURCE(RRDSREAD),DISP=SHR                 00200000
//*                                                                     00210000
