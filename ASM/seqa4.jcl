...
//             TIME=1440,
//             MSGLEVEL=(1,1)
//SEQA4  EXEC ASMFCG,PARM.ASM=(OBJ,NODECK),MAC1='SYS2.MACLIB',
...
SEQA4   START 0                  start main code csect at base 0
        SAVE  (14,12)            Save input registers
        LR    R12,R15            base register := entry address
        USING SEQA4,R12          declare base register
...
*
        ...
        PUT   SYSPRINT,HD1       Display header 1
        PUT   SYSPRINT,HD2       Display header 2
        PUT   SYSPRINT,HD3       Display header 3
        PUT   SYSPRINT,HD4       Display header 4
*        
...
HD2      DS    0CL80
         ...
         DC    CL40' '
HD3      DS    0CL80
         DC    CL41' ID#        Name         Degr  Ten  Phone'
         DC    CL19' '
         DC    CL20' '
HD4      DS    0CL80
         DC    CL40'---   ---------------   ----  ---  -----'
...
TEACHERS DCB   DSORG=PS,MACRF=GM,EODAD=ATEND,DDNAME=TEACHERS,          X
        ...
        YREGS ,
        END   SEQA4              define main entry point
/*
